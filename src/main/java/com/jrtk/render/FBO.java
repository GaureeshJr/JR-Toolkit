...
public class FBO {
    ...
    public final int DEPTH_TEXTURE = 1;
    public final int DEPTH_RENDER_BUFFER = 2;

    private final int width;
    private final int height;
    private final int filtering;
     ...
     *            this FBO should use.
     */
    public FBO(int width, int height, int depthBufferType, int filtering) {
        this.width = width;
        this.height = height;
